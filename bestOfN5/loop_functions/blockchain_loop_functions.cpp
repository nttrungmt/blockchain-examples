...
CColor CBlockchainVotingLoopFunctions::GetFloorColor(const CVector2& c_position_on_plane) {
    if( /*(c_position_on_plane.GetX() > -1.250f) && (c_position_on_plane.GetX() < 1.250f) &&*/
        (c_position_on_plane.GetY() > -0.20f) && (c_position_on_plane.GetY() <= 0.80f)) {
      return CColor::BLACK;
    }
    
    else if(/*(c_position_on_plane.GetX() > -1.250f) && (c_position_on_plane.GetX() < 1.250f) &&*/
            (c_position_on_plane.GetY() > 0.80f) && (c_position_on_plane.GetY() <= 0.88f)){
      return CColor::GREEN;
    }
    
    else if( /*(c_position_on_plane.GetX() > -1.250f) && (c_position_on_plane.GetX() < 1.250f) &&*/
             (c_position_on_plane.GetY() > -0.28f) && (c_position_on_plane.GetY() <= -0.20f)){
      return CColor::BLUE;
    }
